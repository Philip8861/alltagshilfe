...
export const PARTNER_TIP_STATUS_BADGE_CLASS: Record<PartnerTipAdminStatus, string> = {
  ...
  bezahlt: "border-emerald-400/80 bg-emerald-600 text-white ring-1 ring-emerald-200/90",
  erledigt: "border-emerald-400/80 bg-emerald-600 text-white ring-1 ring-emerald-200/90",
...
export const PARTNER_TIP_STATUS_SELECT_CLASS: Record<PartnerTipAdminStatus, string> = {
  ...
  bezahlt: "border-emerald-300 bg-emerald-50/40 focus:border-emerald-600 focus:ring-emerald-500/25",
