/** FAQ-Inhalt für /pflegeberatung/betriebliche-pflegeberatung (Accordion + JSON-LD) */

export type BetrieblichePflegeberatungFaqItem = {
  question: string;
  answer: string;
};

export const BETRIEBLICHE_PFLEGEBERATUNG_FAQ: BetrieblichePflegeberatungFaqItem[] =
  [
    {
      question:
...
export function betrieblichePflegeberatungFaqJsonLd() {
  return {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: BETRIEBLICHE_PFLEGEBERATUNG_FAQ.map((item) => ({
      "@type": "Question",
      name: item.question,
