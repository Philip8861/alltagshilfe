  ...
  return (
    <div className="min-w-0 overflow-x-clip overflow-y-visible bg-[#fafbfc] text-neutral-700 antialiased">
      <article id="standort-landing" className="min-w-0 scroll-mt-24 overflow-x-clip overflow-y-visible">
              ...
              <div className="order-1 flex min-w-0 flex-col items-center gap-6 text-center lg:order-2">
                ...
                <div className="mx-auto w-full max-w-md">
                  ...
                  <GtmPhoneLink
                    ...
                    sourceComponent="standort_sidebar_tel"
                    plz={routingPlz}
                  ...
                  <section className="mt-8 border-t border-neutral-200 pt-6" aria-labelledby="standort-whatsapp-heading">
                    ...
                    <p className="mt-3 text-sm text-neutral-700">
                      Nutzen Sie den Button – Sie erreichen uns zentral per WhatsApp (08376 / 9769317), unabhängig vom
                      Standort.
                    </p>
                    <div className="mt-4 flex justify-center">
                      <GtmWhatsappLink
                        ...
                        sourceComponent="standort_sidebar_whatsapp"
                        plz={routingPlz}
                        service={standort.pageSlug}
                        ...
                        aria-label="Per WhatsApp schreiben (zentrale Nummer)"
                      >
                    ...
                    <div className="mt-4 flex w-full justify-center">
                      <Image
                        ...
                        alt="QR-Code für WhatsApp (zentrale Nummer 08376 / 9769317)"
                        width={202}
                        height={202}
        ...
        <section
          className="relative z-20 overflow-x-clip bg-[#F2F9FA] pb-14 pt-[clamp(4rem,7vw+1.75rem,6.75rem)] sm:pb-16 sm:pt-[clamp(4.5rem,8vw+2rem,7.25rem)] lg:pb-20"
          ...
          <div className="relative z-[1] mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-4xl">
            <RevealOnScroll>
              ...
              <p className="mx-auto mt-2 max-w-2xl text-center text-sm font-medium text-[#0F4F68]/85 sm:text-base">
                ...
                <Link href={`${HAUSHALTSHILFE_URL}#haushalt-faq-heading`} className={STANDORT_FAQ_LINK_CLASS}>
                  FAQ Haushaltshilfe
                </Link>
              </p>
            </RevealOnScroll>
