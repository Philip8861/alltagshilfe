...
/** Vorteile auf den Stellenkarten (ohne Pflegeberater*in). */
const STELLEN_VORTEILE_STANDARD = [
...
/** Pflegeberater*in: drei Haken ersetzen die früheren fünf Standard-Punkte. */
    ...
    >
      ...
      <div className="relative left-1/2 mt-8 flex w-screen max-w-[100vw] -translate-x-1/2 justify-center px-4 sm:mt-10 sm:px-5 lg:px-8">
        ...
        {jobs.map((job, index) => {
          ...
          const stellenVorteile =
            job.id === "pflegeberater" ? STELLEN_VORTEILE_PFLEGEBERATER : STELLEN_VORTEILE_STANDARD;
          return (
            <li
              key={job.id}
