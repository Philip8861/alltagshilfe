...
/** Person mit Abgangs-Pfeil – Fluktuation / Weggang */
...
/** Kalender mit steigenden Balken – Zunahme von Fehlzeiten */
        ...
        >
          ...
          <div className="mx-auto mt-5 max-w-4xl space-y-4 text-pretty text-neutral-700 leading-relaxed sm:space-y-5 sm:text-[1.05rem]">
            <p className={POP_IN} style={{ animationDelay: `${WAS_BODY_DELAYS[0]}ms` }}>
              Die betriebliche Pflegeberatung ist ein Corporate Benefit, den Sie als Arbeitgeber für Ihr Unternehmen
              abschließen können. Sie unterstützen damit Ihre Mitarbeitenden genau in den Momenten, in denen private
              Pflegesituationen plötzlich zur Belastung werden.
            </p>
            <p className={POP_IN} style={{ animationDelay: `${WAS_BODY_DELAYS[1]}ms` }}>
              Er basiert auf unserer langjährigen Erfahrung und auf dem häufigsten Satz, den wir hören:{" "}
              <strong className="font-semibold text-[#0F4F68]">
                „Hätte ich das eher gewusst, wäre vieles leichter gewesen.“
              </strong>
            </p>
            <details
              className="group mt-2 border-t border-[#0F4F68]/12 pt-4 sm:mt-3 sm:pt-5"
              aria-label="Weiterführender Text zur betrieblichen Pflegeberatung"
            >
              <summary className="cursor-pointer list-none rounded-sm text-center text-base font-semibold text-[#0F4F68] underline decoration-2 underline-offset-4 hover:text-[#0c3d52] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0F4F68] focus-visible:ring-offset-2 [&::-webkit-details-marker]:hidden">
                <span className="group-open:hidden">Jetzt weiterlesen</span>
                <span className="hidden group-open:inline">Weniger anzeigen</span>
              </summary>
              <div className="mt-4 space-y-4 sm:mt-5 sm:space-y-5">
                <p>
                  Denn im Alltag entsteht genau hier die größte Herausforderung: Mitarbeitende starten nach Feierabend oft
                  eine zweite Schicht und müssen sich mit Formularen, Anträgen, Telefonaten, Haushalt und organisatorischen
                  Aufgaben auseinandersetzen. Diese zusätzliche Belastung führt zu Stress, Überforderung und wirkt sich
                  direkt auf Konzentration, Leistungsfähigkeit und Fehlzeiten aus. Unternehmen, die hier gezielt unterstützen,
                  können Fehlzeiten reduzieren und die Leistungsfähigkeit ihrer Mitarbeitenden stabilisieren.
                </p>
                <p>
                  Hier kommen wir ins Spiel: Wir sind Ihre externen Profis im Betrieb und unterstützen Ihre Mitarbeitenden
                  schnell und unkompliziert, direkt vor Ort oder zu Hause. Wir übernehmen die gesamte Organisation, damit
                  Entlastung spürbar wird und finanzielle Leistungen sicher ankommen.
                </p>
                <p>
                  Für Sie als Unternehmen bedeutet das eine verlässliche, feste Kooperation mit uns. Gegen einen günstigen
                  monatlichen Festbetrag, abhängig von der Unternehmensgröße, erhalten Ihre Mitarbeitenden unbegrenzten Zugang
                  zu Beratung und fachlicher Unterstützung. Es gibt keine Einzelabrechnung, keinen Mehraufwand und keine
                  Begrenzung.
                </p>
                <p>
                  Sie können diesen neuen Benefit aktiv im Unternehmen kommunizieren und als festen Bestandteil Ihrer
                  Arbeitgeberleistungen etablieren. Damit zeigen Sie echte Fürsorge und übernehmen Verantwortung für Ihre
                  Mitarbeitenden.
                </p>
                <p>
                  Das Ergebnis ist spürbar im Alltag: Mitarbeitende werden entlastet und bleiben leistungsfähiger.
                  Gleichzeitig können Überlastung sowie Fehl- und Ausfallzeiten bei diesen Mitarbeitenden deutlich sinken und
                  Ihr Unternehmen wird als moderner und verantwortungsvoller Arbeitgeber wahrgenommen.
                </p>
              </div>
            </details>
          </div>
