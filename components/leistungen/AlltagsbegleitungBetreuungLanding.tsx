...
const AB_LANDING_FAQ = buildStandortStyleFaq(null);
const AB_LANDING_FAQ_JSON_LD = standortFaqJsonLd(AB_LANDING_FAQ);

const HERO_IMG = "/images/leistungen_alltagsbegleitung.webp";
  ...
  return (
    <div className="min-w-0 overflow-x-clip overflow-y-visible bg-[#fafbfc] text-neutral-700 antialiased">
      <article id="alltagsbegleitung-betreuung-hero" className="min-w-0 scroll-mt-24 overflow-x-clip overflow-y-visible">
        <section className="relative z-0 box-border mx-auto w-full min-w-0 max-w-7xl px-4 pb-10 pt-0 sm:px-6 sm:pb-16 lg:px-[var(--ahs-page-gutter)] lg:pb-[clamp(4rem,9vh+1.5rem,7rem)] lg:pt-[clamp(2rem,5vh+1.25rem,4.75rem)] xl:pb-[clamp(5rem,10vh+1.5rem,8rem)]">
          <div className="flex flex-col-reverse items-center gap-10 lg:grid lg:grid-cols-[minmax(0,0.34fr)_minmax(0,0.66fr)] lg:items-center lg:justify-items-stretch lg:gap-x-[clamp(1.5rem,3vw,3.25rem)] lg:gap-y-0">
            <div className="box-border w-full min-w-0 max-w-full space-y-[clamp(1.25rem,2vh+0.75rem,1.75rem)] lg:min-w-0 lg:justify-self-start lg:space-y-[clamp(1.15rem,1.6vh+0.7rem,1.75rem)] lg:-translate-x-[clamp(0.75rem,4.5vw,3rem)] lg:pr-0 motion-reduce:lg:translate-x-0">
              <h1
                className="text-3xl font-extrabold leading-tight tracking-tight text-[#0F4F68] opacity-0 motion-reduce:opacity-100 animate-fade-in-up sm:text-4xl lg:text-[clamp(1.75rem,1.05rem+2.5vw,3rem)] lg:leading-[1.28]"
              ...
              >
                <GtmKontaktNavLink
                  href="/kontakt"
                  contactPath="alltagsbegleitung_landing_hero_kontakt_nav"
                  sourceComponent="AlltagsbegleitungBetreuungLanding"
                  service="alltagsbegleitung_betreuung"
        ...
        <JetztNeuPromoSection headingId="ab-jetzt-neu-promo" />
          ...
          <div className="relative z-[1] mx-auto max-w-7xl">
            ...
            <RevealOnScroll delayMs={200}>
              <div className="mt-10 flex flex-col items-center gap-2 sm:mt-12">
                <GtmKontaktNavLink
                  href="/kontakt"
                  contactPath="alltagsbegleitung_landing_steps_anfrage_nav"
                  sourceComponent="AlltagsbegleitungBetreuungLanding"
                  service="alltagsbegleitung_betreuung"
        ...
        <section className="relative bg-[#fafbfc] py-14 sm:py-20" aria-labelledby="ab-faq-heading">
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(AB_LANDING_FAQ_JSON_LD) }} />
        </section>
          ...
          <RevealOnScroll>
            <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
              <p className="text-neutral-600">
                ...
                <GtmKontaktNavLink
                  href="/kontakt"
                  contactPath="alltagsbegleitung_landing_footer_inline_kontakt_nav"
                  sourceComponent="AlltagsbegleitungBetreuungLanding"
                  service="alltagsbegleitung_betreuung"
              ...
              <GtmKontaktNavLink
                href="/kontakt"
                contactPath="alltagsbegleitung_landing_footer_cta_nav"
                sourceComponent="AlltagsbegleitungBetreuungLanding"
                service="alltagsbegleitung_betreuung"
