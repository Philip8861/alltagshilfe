...
const SLUG = "platzhalter-layout-b" as const;
      ...
      <article className="min-w-0 bg-white pb-16 pt-0 sm:pb-24">
        <div className="mx-auto w-full max-w-[1120px] px-4 sm:px-6 lg:px-8">
          <RatgeberPlatzhalterArticleView
            ...
            breadcrumbLabel="Platzhalter B"
            body="Zweiter Platzhalter mit gleichem Aufbau wie A – für den Vergleich im Vier-Spalten-Raster. Nicht zur Veröffentlichung gedacht."
          />
        </div>
      </article>
    </>
