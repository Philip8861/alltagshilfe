    ...
    <article className="min-w-0 pb-14 sm:pb-20">
      ...
      <Container className="max-w-4xl pt-10 sm:pt-12">
        <p className="text-lg leading-relaxed text-neutral-700">
          Mit Pflegegrad 2 ändert sich die finanzielle Situation spürbar: Es gibt erstmals frei verfügbares Pflegegeld,
          Budgets für Pflegesachleistungen und ein großes Jahresbudget für Ersatzpflege. In diesem Leitfaden finden Sie
          die wichtigsten Zahlen für 2026, die Voraussetzungen sowie die Pflicht zum Beratungseinsatz nach §37.3 SGB XI.
        </p>
