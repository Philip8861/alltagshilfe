...
export const metadata: Metadata = {
  ...
  description:
    "Informationen zur barrierefreien Homepage von Alltagshilfe-Süd: Einstellungen für Schriftgröße, Kontrast, Vorlesemodus und Cursor.",
};
