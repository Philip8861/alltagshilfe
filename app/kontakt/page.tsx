              ...
              {selectedStandort && (
                ...
                >
                  ...
                  <GtmPhoneLink
                    ...
                    sourceComponent="kontakt_page_context_standort_tel"
                    plz={selectedPlz}
                    service={selectedStandort.pageSlug}
          ...
          <div className="order-1 flex min-w-0 flex-col items-center gap-6 text-center lg:order-2">
            ...
            >
              ...
              <GtmPhoneLink
                ...
                sourceComponent="kontakt_page_zentraltel"
              ...
              >
                ...
                <div className="mt-4 flex justify-center">
                  <GtmWhatsappLink
                    href={ZENTRALE_WHATSAPP_WA_ME_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    sourceComponent="kontakt_page_whatsapp"
