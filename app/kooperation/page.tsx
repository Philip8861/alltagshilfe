    ...
    <article className="overflow-x-visible pb-0 sm:pb-0" style={{ backgroundColor: PAGE_SURFACE }}>
      <header className="overflow-visible bg-white">
        <div className="mx-auto max-w-7xl overflow-visible px-4 pt-2 pb-10 sm:px-6 sm:pt-4 sm:pb-14 lg:px-[var(--ahs-page-gutter)] lg:pt-16 lg:pb-20">
          <div className="mx-auto flex w-full max-w-[min(100%,72rem)] flex-col items-center gap-4 overflow-visible lg:mx-auto lg:flex-row lg:justify-center lg:items-center lg:gap-x-[1.375rem] lg:gap-y-6 xl:gap-x-[1.875rem]">
            <div className="flex w-full min-w-0 shrink-0 justify-center overflow-visible lg:max-w-[min(100%,809px)] lg:-translate-x-[15%] lg:-ml-2 lg:-mr-2 xl:-ml-3 xl:-mr-4">
